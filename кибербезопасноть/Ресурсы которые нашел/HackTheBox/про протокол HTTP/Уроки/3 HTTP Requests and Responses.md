...
If we click on the Network tab and refresh the page, we should be able to see the list of requests sent by the page: ![Network tab showing two GET requests to 188.166.146.97:31122. Status 304 for '/' and 404 for 'favicon.ico'.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/35/devtools_network_requests.jpg)
