...
To create a timer for systemd, we need to create a directory where the timer script will be stored.
        ...
        shellsession
`august852@htb[/htb]$ sudo mkdir /etc/systemd/system/mytimer.timer.d august852@htb[/htb]$ sudo vim /etc/systemd/system/mytimer.timer`
...
#### Create a Service
        ...
        shellsession
`august852@htb[/htb]$ sudo vim /etc/systemd/system/mytimer.service`
...
#### Reload Systemd
        ...
        shellsession
`august852@htb[/htb]$ sudo systemctl daemon-reload`
...
#### Start the Timer & Service
        ...
        shellsession
`august852@htb[/htb]$ sudo systemctl start mytimer.timer august852@htb[/htb]$ sudo systemctl enable mytimer.timer`
