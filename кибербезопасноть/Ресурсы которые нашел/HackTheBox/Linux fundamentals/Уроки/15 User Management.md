...
#### Execution as a user
        ...
        shellsession
`august852@htb[/htb]$ cat /etc/shadow cat: /etc/shadow: Permission denied`
...
#### Execution as root
        ...
        shellsession
`august852@htb[/htb]$ sudo cat /etc/shadow root:<SNIP>:18395:0:99999:7::: daemon:*:17737:0:99999:7::: bin:*:17737:0:99999:7::: <SNIP>`
