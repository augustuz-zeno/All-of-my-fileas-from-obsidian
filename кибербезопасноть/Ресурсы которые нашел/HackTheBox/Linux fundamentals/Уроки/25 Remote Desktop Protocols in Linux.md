...
#### X11Forwarding
        ...
        shellsession
`august852@htb[/htb]$ cat /etc/ssh/sshd_config | grep X11Forwarding X11Forwarding yes`

With this we can start the application from our client with the following command:

        shellsession
`august852@htb[/htb]$ ssh -X htb-student@10.129.23.11 /usr/bin/firefox htb-student@10.129.14.130's password: ******** <SKIP>`
...
#### Setting Up an SSH Tunnel
        ...
        shellsession
`august852@htb[/htb]$ ssh -L 5901:127.0.0.1:5901 -N -f -l htb-student 10.129.14.130 htb-student@10.129.14.130's password: *******`
