...
#### Install OpenSSH
        ...
        shellsession
`august852@htb[/htb]$ sudo apt install openssh-server -y`
...
#### Install NFS
        ...
        shellsession
`august852@htb[/htb]$ sudo apt install nfs-kernel-server -y`
...
#### Install Apache Web Server
        ...
        shellsession
`august852@htb[/htb]$ sudo apt install apache2 -y`
...
#### Install Python & Web Server
        ...
        shellsession
`august852@htb[/htb]$ sudo apt install python3 -y august852@htb[/htb]$ python3 -m http.server`
...
When we run this command, our Python Web Server will be started on the `TCP/8000` port, and we can access the folder we are currently in. We can also host another folder with the following command:
        ...
        shellsession
`august852@htb[/htb]$ python3 -m http.server --directory /home/cry0l1t3/target_files`
...
This will start a Python web server on the `TCP/8000` port, and we can access the `/home/cry0l1t3/target_files` folder from the browser, for example. When we access our Python web server, we can transfer files to the other system by typing the link in our browser and downloading the files. We can also host our Python web server on a port other than the default port:
        ...
        shellsession
`august852@htb[/htb]$ python3 -m http.server 443`
...
#### Install OpenVPN
        ...
        shellsession
`august852@htb[/htb]$ sudo apt install openvpn -y`
...
#### Connect to VPN
        ...
        shellsession
`august852@htb[/htb]$ sudo openvpn --config internal.ovpn`
